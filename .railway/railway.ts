 ...
 *
 * Serverless-ready architecture: HTTP handler + external cron service.
 * Background tasks (scheduler, health checks) are triggered via HTTP endpoints
 * called by an external cron service (EasyCron, Railway Cron, etc).
 */
