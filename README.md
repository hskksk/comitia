...
| [10 シナリオ検証と MVP](docs/10-scenarios-and-mvp.md) | 検証シナリオ 4 本と MVP の切断線。M5 コード完了、次は M6-1 |
| [シナリオ検証の結果](docs/scenarios/README.md) | 4 本の紙上検証の書き下し、発見と処置 |
| [設計 00: マイルストーン](docs/design/00-milestones.md) | 完了分とこの先。いまは M5 コード完了、次は M6-1 |
...
| [設計 04: 人間の利用](docs/design/04-human-usability.md) | M6-1〜M6-5（見た目・操作感・提案と作業・CLI・ログ） |
