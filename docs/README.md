...
10. [シナリオ検証と MVP](10-scenarios-and-mvp.md) — 検証シナリオ 4 本と MVP の切断線。M5 コード完了、live dogfood は [ops/m5-dogfood.md](ops/m5-dogfood.md)
...
- [設計 03: 技術選定とエンジン・プロトコル検証](design/03-tech-selection.md) — エンジン実現性マトリクス、A2A/MCP 採用（PoC で確定）、スタック、マイルストーン
...
- 次に何をやるかは 10（M5 コード完了。live 運転は ops/m5-dogfood.md）
