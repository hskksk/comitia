...
10. [シナリオ検証と MVP](10-scenarios-and-mvp.md) — 検証シナリオ 4 本と MVP の切断線。M7 コード完了、次は第 2 層（M8〜M11）
...
- [設計 06: 第 2 層（M8〜M11）](design/06-layer2.md) — 着手表明、個別記憶と公開メモ、時間の合意種類、決定の見え方
