...
要件の意味は [03 スレッドと合意](03-threads-and-consensus.md) が正本。この文書は **いまボードが強制している遷移と、誰がどの口を叩けるか** を図にする。合意種類を軸にした合意状態の遷移は [合意種類ごとの合意状態遷移](03-consensus-state-machines.md)。
